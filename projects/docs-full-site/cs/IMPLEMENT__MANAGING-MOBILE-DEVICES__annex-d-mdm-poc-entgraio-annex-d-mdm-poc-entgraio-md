...
---
# Příloha D - MDM PoC: Entgra.io  { #annex-d-mdm-poc-entgraio } 
...
![Entgra MDM console](../content/mdm/resources/images/image11.png)


Telefon

![Entgra MDM běžící na Android](../content/mdm/resources/images/image2.png){ width=25% }
