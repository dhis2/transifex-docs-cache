...
# Konfigurace DHIS2 pro použití aplikace pro Android  { #configuration } 
...
## Aspekty související se zabezpečením { #configuration_security } 

<!--DHIS2-SECTION-ID:configuration_security-->

### Používání sdílení DHIS 2 a omezení sdílení { #configuration_security_sharing_restrictions } 
...
### Praktické pokyny pro zabezpečení dat { #configuration_security_guidelines } 
...
## Vytvoření uživatele systému Android { #configuration_user } 

<!--DHIS2-SECTION-ID:configuration_user-->

### Vytvořit roli { #configuration_user_role } 
...
### Vytvořit uživatele { #configuration_user_user } 
...
### Přiřadit organizační jednotky { #configuration_user_ou } 
...
## Vizuální konfigurace: Porozumění tomu, co se vykresluje a proč { #configuration_visual } 
...
## Nastavení pravidel programu { #configuration_pr } 
...
## Definování indikátorů a legend programu { #configuration_pi } 
...
## Vyhrazená ID  { #configuration_reserved_id } 
