...
Além disso, o documento contém secções para novos recursos de login, configurações visuais, gerenciamento de sincronização e uma lista de erros importantes conhecidos.
