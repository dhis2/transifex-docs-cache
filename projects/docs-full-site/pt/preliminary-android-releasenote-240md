# DHIS2 Android App versão 2.4 Notas de Lançamento

DHIS2 [Android Capture App 2.4](https://www.dhis2.org/android-2-4) foi lançado com muitas melhorias.
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-3527) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot01.png)
...
**Elementos de dados obrigatórios são sempre exibidos:** Quando um elemento de dados é configurado como obrigatório, não será oculto pelas regras do programa. Este comportamento está alinhado com o aplicativo Web Capture.

[Jira](https://jira.dhis2.org/browse/ANDROAPP-3497) 

**Aplicar legendas aos campos do elemento de dados:** Agora, se um elemento de dados numéricos tiver uma legenda, o aplicativo exibirá um emblema com a cor e a descrição para o valor de legenda fornecido.
...
## EVENTOS E ENTRADA DE DADOS DO TRACKER
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-3463) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot24.png)

## ENTRADA DE DADOS DE CONJUNTOS DE DADOS
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-3464) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot25.png)
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-3466) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot17.png)
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-3467) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot05.png)


## PESQUISA TEI, REGISTRO E PAINEL
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-3039) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot16.png)
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-651) | [Screenshot](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot14.png) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot15.png)
...
[Jira](https://jira.dhis2.org/browse/ANDROAPP-2510) | [Captura de tela](https://s3-eu-west-1.amazonaws.com/content.dhis2.org/dhis2-android/release+notes+2.4/2.4-release-screenshot13.png)
...
|Detalhes sobre cada recurso no JIRA (requer login)|[2.4 Recursos](https://jira.dhis2.org/issues/?filter=11956)|
|Visão geral dos bugs corrigidos no JIRA (requer login)|[2.4 Bugs](https://jira.dhis2.org/issues/?filter=11957)|
|Instância de demonstração (usuário / senha)|[https://play.dhis2.org/demo/ ](https://play.dhis2.org/demo/) android / Android123|
|Comunidade DHIS 2|[https://community.dhis2.org Comunidade Móvel ](https://community.dhis2.org/c/subcommunities/mobile/16)|
