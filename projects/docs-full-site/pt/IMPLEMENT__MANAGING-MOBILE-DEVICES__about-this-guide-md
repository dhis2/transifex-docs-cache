...
> ** Cuidado **
>
> As informações contidas nessas seções devem ser cuidadosamente consideradas e, se não forem atendidas, podem resultar em resultados inesperados na análise, desempenho ou funcionalidade.

> ** Aviso **
>
> As informações contidas nessas seções, se não forem atendidas, podem resultar na perda permanente de dados ou afetar a usabilidade geral do sistema.
...
> ** Não_aplicável **
>
> As informações contidas nessas seções indicarão que essas questões não são aplicáveis.

> ** Trabalho_em_progresso**
>
> As informações contidas nessas seções indicarão que esses são problemas ou falhas não totalmente implementados ou com comportamento inesperado já relatado.
