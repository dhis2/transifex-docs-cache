...
يوجد أيضًا دليل سريع يسرد الخطوات باختصار شديد والمقصود منه أن يكون دليل بحث أو "ورقة غش" أثناء إجراء العرض التوضيحي، لمساعدة المدرب على تذكر جميع الخطوات وسير العرض التوضيحي.
...
العرض التجريبي المباشر: 1.5 ساعة
...
3. إنشاء قاعدة برنامج باستخدام برنامج السل
...
## العرض التجريبي المباشر خطوة بخطوة { #live-demo-step-by-step }
...
**قم بإنشاء الإجراء ("إخفاء الحقل" في عنصر بيانات موقع EBTB).**

**في هذه المرحلة، اشرح الإجراءات المختلفة المتوفرة مرة أخرى.**

يمكن الاطلاع على القائمة الكاملة للإجراءات في [الوثائق](https://docs.dhis2.org/en/use/user-guides/dhis-core-version-master/configuring-the-system/programs.html# تكوين_برنامج_القاعدة).
...
إخفاء سؤال الحمل إذا كان الجنس ذكرا
...
### توقف - اطلب من المشاركين أداء التمرين 2 في دليل المتعلم { #stop-have-the-participants-perform-exercise-2-in-the-learners-guide }
...
** قم بتقديم إجراء قاعدة البرنامج **
...
**إنشاء وشرح التعبير. سوف نستخدم دالة تسمى d2:hasValue للتحقق مما إذا كان هناك أي قيمة لعنصر البيانات**
...
**تسجيل كيان جديد وإدخال تاريخ الميلاد**
